...
export default function Hero() {
    ...
    const aboutme = [
        {
          text:
            'Hi, my name is Owais Shah and I began using WordPress when it first began. I’ve spent most of my waking hours for the last ten years designing, programming and operating WordPress sites.',
        },
        {
          text:
    ...
    return (
        <>
            <div class=' hero flex justify-between laptop:flex-wrap laptop:items-center laptop:gap-8 Pc:mt-120 Desktop:mt-120 laptop:mt-120 mobile:mt-60
            mobile:flex mobile:flex-col smallmobile:flex-col mobile:justify-center Pc:px-120 Desktop:px-80 laptop:px-120 mobile:px-60 smallmobile:px-30'>
