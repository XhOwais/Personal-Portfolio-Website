    ...
    return (
        <>
            <div className=' relative ' id>
                ...
                <ul className='h-140 w-550 m-auto mt-32 smallmobile:h-90 flex justify-between px-30 smallmobile:px-15 rounded-3xl items-center gap-8 smallmobile:gap-2 mobile:w-550 smallmobile:w-auto smallmobile:mx-60  bg-bg '>
                ...
                <div className=' w-full h-450 bg-second absolute bottom-0 -z-50 top-64 smallmobile:top-80 translate-y-24 flex justify-center rounded-t-3xl'>
                </div>               
            </div>
        </>
    )
