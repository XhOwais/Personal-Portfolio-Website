...
export default function Footer() {
    return(
        ...
        <div className=' relative flex'>
            <div className=" w-auto h-600 mobile:h-auto rounded-3xl bg-heading mobile:py-42 mx-120 Desktop:mx-60 laptop:mx-60 mobile:mx-60 smallmobile:mx-25 px-80 smallmobile:px-32 flex items-center mt-60 ">
            <div className=' flex gap-8 items-center laptop:flex-col-reverse mobile:flex-col-reverse smallmobile:flex-col-reverse'>
                ...
                <div className=" w-360 h-360 laptop:w-300 laptop:h-300 shrink-0  bg-bg rounded-full flex justify-center overflow-hidden ml-32">
                  <img className=' h-360 laptop:h-300 scale-x-[-1]' src={Pic} alt="" srcset="" />
                </div>
            </div>
            </div>
            <div className=' w-full h-450 bg-second absolute -z-50 top-80'>
