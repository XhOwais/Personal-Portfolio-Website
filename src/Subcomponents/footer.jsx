    ...
    return(
        ...
        <div className=' relative flex'>
            ...
            <div className=' flex gap-8 items-center laptop:flex-col-reverse mobile:flex-col-reverse smallmobile:flex-col-reverse'>
                ...
                <div className=" w-360 h-360 laptop:w-300 laptop:h-300 mobile:w-260  mobile:h-260 smallmobile:w-260 smallmobile:h-260 shrink-0  bg-bg rounded-full flex justify-center overflow-hidden ml-32">
                  <img className=' h-360 laptop:h-300 mobile:h-260 smallmobile:h-260 scale-x-[-1]' src={Pic} alt="" srcset="" />
                </div>
            </div>
            </div>
